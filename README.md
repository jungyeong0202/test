...
포켓몬을 우클릭해 `상점`을 열 수 있습니다. 쓰다듬을 때마다 100원, 스스로 100px를 걸을 때마다 100원을 얻습니다. 포켓푸드(400원)는 친밀도를 2 올리고, 성장의 물방울(2,500원)은 진화할 때 1개 소비됩니다. 돈과 아이템 수량은 다음 실행에도 남습니다.
...
진화해야 만날 수 있는 포켓몬은 **`포켓몬 추가` 목록에 나오지 않고**, `--count` 로 무작위로
