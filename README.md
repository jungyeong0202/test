...
- **상점과 진화가 있습니다.** 쓰다듬기와 산책으로 포켓코인을 모아 먹이·성장의 물방울을 사고, 꼬부기를 어니부기로 진화시킬 수 있습니다.
- **모의 주식시장**에서 포켓코인으로 세 종목을 사고팔 수 있습니다. 실제 돈·실제 주가와는 연결되지 않습니다.
...
포켓몬을 우클릭해 `상점`을 열 수 있습니다. 쓰다듬을 때마다 포켓코인 1개, 스스로 100px를 걸을 때마다 포켓코인 1개를 얻습니다. 포켓푸드(4코인)는 친밀도를 2 올리고, 성장의 물방울(25코인)은 진화할 때 1개 소비됩니다. 포켓코인과 아이템 수량은 다음 실행에도 남습니다.

### 모의 주식시장

우클릭 메뉴의 `주식시장`에서 피카츄전기·꼬부기워터·이상해씨농장을 각각 한 주씩 매수하거나 매도할 수 있습니다. 가격은 20초마다 조금씩 변하며, 포켓코인과 보유 주식·가격은 저장됩니다. 이 기능은 게임용이며 실제 금융시장이나 현금과 연결되지 않습니다.
