...
- **상점과 진화가 있습니다.** 쓰다듬기와 산책으로 돈을 모아 먹이·성장의 물방울을 사고, 꼬부기를 어니부기로 진화시킬 수 있습니다.
...
| | |
| --- | --- |
| 언제 | 포켓몬을 **8번 쓰다듬고 600px를 산책**한 뒤, `성장의 물방울` 1개가 있으면 진화할 준비가 됩니다 |
| 어떻게 | 두 모습의 하얀 실루엣이 점점 빠르게 번갈아 번쩍이다가, 새하얗게 머문 뒤 진화한 모습이 됩니다 |
| 결정 | 준비가 되면 우클릭 메뉴의 `어니부기로 진화하기`를 눌러 직접 시작합니다 |
| 진행 상황 | 조건이 남아 있으면 우클릭 메뉴에 남은 쓰다듬기·산책 거리가 나옵니다 |
| 그 뒤 | 있던 자리와 보던 방향을 그대로 이어받고, 설정에 저장되어 다음에 켤 때도 진화한 모습입니다 |

### 상점

포켓몬을 우클릭해 `상점`을 열 수 있습니다. 쓰다듬기는 친밀도만 올리고, **스스로 100px를 걸을 때마다 100원**을 얻습니다. 포켓푸드(8,000원)는 친밀도를 2 올리고, 먹은 포켓몬의 산책 속도와 산책 수입을 5분 동안 약 2배로 만듭니다. 성장의 물방울(2,500원)은 진화할 때 1개 소비됩니다. 돈과 아이템 수량은 다음 실행에도 남습니다.
