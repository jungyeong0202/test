...
우클릭 메뉴의 `주식시장 열기`를 누르면 별도 오버레이 창이 열립니다. 피카츄전기·꼬부기워터·이상해씨농장을 각각 한 주씩 매수하거나 매도할 수 있고, 최근 20회의 가격 변동을 선 그래프로 볼 수 있습니다. 가격은 20초마다 100원 단위로 조금씩 변하며, 돈과 보유 주식·가격은 저장됩니다. 이 기능은 게임용이며 실제 금융시장이나 현금과 연결되지 않습니다.
