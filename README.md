...
포켓몬을 우클릭해 `상점`을 열 수 있습니다. **데리고 있는 1초마다 55원**을 얻습니다. 걷든 서 있든 벌이는 같습니다(일시정지 중에는 벌지 않습니다). 등급과 진화 단계에 따라 곱해집니다 — 준전설 3배, 초전설 5배, 2단계 1.5배, 3단계 2.25배입니다. 준전설·초전설은 진화하지 못하는 대신, 일반 포켓몬을 끝까지 키운 것(2.25배)보다 많이 법니다. 포켓푸드(8,000원)는 친밀도를 2 올리고, 먹일 때마다 걸음이 빨라지고 **초당 55원을 더 버는** 시간을 5분씩 누적합니다(16,500원어치 — 등급이 높아도 더 주지 않습니다). 성장의 물방울은 진화할 때 1개 소비됩니다. 돈과 아이템 수량은 다음 실행에도 남습니다.
