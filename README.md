...
- 포켓몬마다 이동 방식이 다릅니다. 메타몽은 걷지 않고 뛰어서 다닙니다.
...
```
피카츄        파이리        이상해씨       꼬부기       메타몽
pikachu    charmander    bulbasaur    squirtle      ditto
```

모두 그림에서 들여온 도트입니다. 네 마리는 걷기 4프레임이고, **메타몽은 다리가 없어
웅크렸다 늘어나며 폴짝폴짝 뛰어다닙니다**(3프레임).
...
bulbasaur     이상해씨  35x33  4프레임  왼쪽 보는 그림
