...
- 가만히 있을 때는 포켓몬마다 **불꽃·거품·잎·반짝임** 같은 짧은 대기 모션을 합니다.
  둘 이상을 켜면 가까이 마주친 포켓몬이 잠깐 서로 바라보고 **말풍선을 번갈아 띄우며 대화**합니다.
...
포켓몬을 우클릭해 `상점`을 열 수 있습니다. 쓰다듬기는 반응 애니메이션만 보여 주고, **스스로 100px를 걸을 때마다 100원**을 얻습니다. 포켓푸드(8,000원)는 친밀도를 2 올리고, 먹일 때마다 산책 속도와 산책 수입이 약 2배가 되는 시간을 5분씩 누적합니다. 성장의 물방울은 진화할 때 1개 소비됩니다. 돈과 아이템 수량은 다음 실행에도 남습니다.
